...
$email = 'cipitech.com@gmail.com';

// If the e-mail is not working, change the debug option to 2 | $debug = 2;
$debug = 0;

// If contact form don't has the subject input change the value of subject here
$subject = (isset($_POST['subject'])) ? $_POST['subject'] : '[www.cipitech.com] New Message From Contact Form';
...
try {
	...
	$mail->Username = 'cipitech.com@gmail.com';                    // SMTP username
	...
	$mail->AddAddress('haris.tsipis@gmail.com', 'Altin Cipi');     // Add a secondary recipient
